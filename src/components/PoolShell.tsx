import { BarChart3, Bell, Building2, CalendarDays, Gauge, Home, Settings } from "lucide-react";
...
export function PoolShell({
  ...
  const visibleTabs = enterpriseEnabled ? tabs : tabs.filter((tab) => tab.id !== "enterprise");
